        ...
        <el-form :model="addDataForm" :rules="addDataFormRules" status-icon ref="addDataForm" class="demo-ruleForm" label-width="33.33%" label-position="right">
          <el-collapse v-model="activeNames">
            ...
            <el-collapse-item title="Reservoir Information" name="3">
              <el-row :gutter="20" :offset="1" class="f-mart30">
                <el-col :span="12">
                  <el-form-item label="EOR Interest Area (㎡)" label-width="55%">
                      <el-input
                        clearable
                        type="text"
              ...
              <el-row :gutter="20" :offset="1">
                ...
                <el-col :span="12">
                  <el-form-item label="Reservoir Temperature (⁰C)" label-width="55%">
                    <el-input
                      clearable
                      type="text"
              ...
              <el-row :gutter="20" :offset="1">
                ...
                <el-col :span="12">
                  <el-form-item label="Initial Reservior Pressure (MPa)" label-width="55%">
                    <el-input
                      clearable
                      type="text"
              ...
              <el-row :gutter="20" :offset="1">
                ...
                <el-col :span="12">
                  <el-form-item label="Present Pressure (MPa)" label-width="55%">
                    <el-input
                      clearable
                      type="text"
              ...
              <el-row :gutter="20" :offset="1">
                ...
                <el-col :span="12">
                  <el-form-item label="Bubble Point Pressure (MPa)" label-width="55%">
                    <el-input
                      clearable
                      type="text"
            ...
            <div class="different_data" v-if="showDataType == 'Polymer'">
                ...
                <el-row style="margin-bottom:30px;">
                  <el-col :span="6" class="choice_preflush">Please Choose Preflush Or Not ?</el-col>
                  <el-col :span="6">
                    <el-switch
...
export default {
  ...
  data () {
    return {
      ...
      profit: PROFIT, // 利润
      showDataType: 'Polymer', //根据地址参数判断显示哪个数据类型
      addDataForm:{
        unit: 'SI',
        //联系信息
        contactInformation: {
